...
export type AddTaskRequest = paths['/tasks']['post']['requestBody']['content']['application/json'];
export type AddTaskResponse = paths['/tasks']['post']['responses']['200']['content']['application/json'];
